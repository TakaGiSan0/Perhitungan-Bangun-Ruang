...
# Using "with" notation
selected = st.sidebar.radio("Perhitungan Bangun Ruang", ["Pembukaan", "Perhitungan Persegi", "Perhitungan Persegi Panjang", "Perhitungan Segitiga", "Perhitungan Lingkaran"])
